            ...
            List {
                ...
                Section("General") {
                    ...
                    Picker("Language", selection: $appLocale) {
                        Text(
                            "System (\(Locale.current.localizedString(forIdentifier: Locale.current.identifier) ?? "Default"))"
                        )
                ...
                Section("About") {
                    ...
                    Link(
                        destination: URL(
                            string: "https://your-privacy-policy.url")!
                    ) {
                    ...
                    Link(
                        destination: URL(
                            string: "https://your-website.example")!
                    ) {
